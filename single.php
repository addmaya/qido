				...
				<span class="u-block"><?php the_title(); ?>
					<section>
						...
						<ul class="o-networks t-light">
							<li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $postPermalink; ?>"><span class="o-icon s--fb"></span></a></li>
							...
							<li><a target="_blank" href="https://pinterest.com/pin/create/button/?url=<?php echo $postPermalink; ?>&media=<?php echo $pageCoverImage; ?>&description=<?php echo $postTitle; ?>"><span class="o-icon s--pinterest"></span></a></li>
