		...
		<section class="o-page__section">
			<div class="u-box">
				<header class="o-section__header">
					<h1><?php echo $programGroup->name; ?></h1>
					<span class="o-subtitle">
						<?php 
							$programGroupCount = new NumberFormatter("en", NumberFormatter::SPELLOUT);
							echo $programGroupCount->format($programGroup->count);
						?>
					</span>
					<p class="u-pb-m"><?php echo $programGroup->description; ?></p>
				</header>
				<ul class="u-clear">
					<?php 
